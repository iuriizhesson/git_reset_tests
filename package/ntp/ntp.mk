...
define NTP_INSTALL_TARGET_CMDS
	...
	test -z "$(NTP_INSTALL_FILES_y)" || install -D -m 755 $(addprefix $(@D)/,$(NTP_INSTALL_FILES_y)) $(TARGET_DIR)/usr/bin/
	$(INSTALL) -D -m 644 package/ntp/ntpd.etc.conf $(TARGET_DIR)/etc/ntp.conf
endef
